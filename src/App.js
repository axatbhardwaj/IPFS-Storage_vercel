      ...
      return(
        <div className="App">
          <header className="App-header">
            ...
            <img src="https:ipfs.io/ipfs/QmVqKYfEjdHmbWD4qML5RezYakhRQC3aJL5vj2qb4cBu8m" alt="Icon" width="90" height="90"/>
          </header>
          
          <hr />

        <Container>
          <h3> Select a file to upload on the Ethereum Blockchain Storage </h3>
